...
public class PcService {
	...
	public ModelAndView list(Page<Map> page,PCQuery query){
		ModelAndView mv = new ModelAndView();
		StringBuilder hql = new StringBuilder("select pc.pcname as pcname, pc.addtime as addtime, pc.mac as mac, pc.cpu as cpu, pc.harddrive as harddrive, pc.uuid as uuid,"
